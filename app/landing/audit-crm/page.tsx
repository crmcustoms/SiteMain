...
export default async function AuditCrmPage() {
  // Используем только украинский язык
  const locale = 'ua';
    ...
    <div className="container mx-auto">
      ...
      <section className="py-16 md:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="grid grid-cols-2 gap-x-4 gap-y-6 mb-8">
              <div>
                ...
                <p className="font-semibold text-xl">Від 2 500 ₴</p>
              </div>
              <div>
                <p className="text-sm text-muted-foreground">Термін</p>
                <p className="font-semibold text-xl">3-7 днів</p>
              </div>
            </div>
            
            <div className="flex gap-4 flex-col sm:flex-row">
              <ContactFormDialog
                trigger={<Button className="bg-amber hover:bg-amber-hover text-black" size="lg">Замовити аудит</Button>}
          ...
          <img
            src="/images/landings/audit/hero.jpg"
            alt="Аудит і стратегія розвитку CRM"
