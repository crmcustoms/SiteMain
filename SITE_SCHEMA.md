...
- На сторінці **списку блогу** автор відображається як **фіксований текст «CRM Customs»** і логотип (`/logo.svg`). Значення з Notion (relation або інше поле) **не використовуються**.
