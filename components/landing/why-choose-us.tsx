      ...
      <div className="relative max-w-[1400px] mx-auto px-8">
        <div className="mb-16">
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h2 className="text-5xl font-black text-black uppercase tracking-tighter">{dict.title || "Як ми допомагаємо з CRM"}</h2>
            </div>
          </div>
          <p className="text-lg text-black/70 max-w-3xl ml-16">
            {dict.subtitle || "Незалежно від того, чи тільки починаєте з CRM чи вже її використовуєте — у нас є рішення для вас"}
          </p>
        </div>
