  ...
  const testimonials: Testimonial[] = [
    {
      ...
      companyLogo: "/images/testimonials/itcomms-logo.png",
      companyImage: "/images/testimonials/itcomms-office.jpg",
          ...
          <div className="overflow-hidden">
            ...
            >
              {testimonials.map((testimonial) => (
                ...
                >
                  <div className="border-2 border-black/10 bg-white flex flex-col h-full hover:border-[#FFD700]/50 transition-colors relative overflow-hidden">
                    {/* Company Image Banner (for featured testimonials) */}
                    {testimonial.companyImage && (
                      <div className="relative w-full h-32 overflow-hidden bg-black/5">
                        <Image
                    ...
                    <div className="p-6 flex flex-col h-full">
                      ...
                      {/* Company Logo (for featured testimonials) */}
