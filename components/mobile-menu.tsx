        ...
        <DrawerFooter className="pt-2">
          <div className="flex flex-col gap-4">
            <div className="flex justify-center gap-4 flex-col items-center">
              ...
              <a
                href="tel:+380671706703"
                className="text-sm font-medium text-foreground hover:text-amber transition"
                title="Позвонить или отправить в Viber"
              >
                +380 67 170-67-03
              </a>
            </div>
